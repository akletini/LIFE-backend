package akletini.life.core.mail;
...
import static akletini.life.core.shared.utils.DateUtils.*;
...
public class MailServiceImpl implements MailService {
    ...
    private void computeIntervals(List<Chore> chores, LocalDate endDate) {
        ...
        for (Chore chore : chores) {
            ...
            Date date = addInterval(interval, interval.getValue(),
                    localDateToDate(chore.getDueAt()));
